...
class PaymentMethodSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Load existing payment methods when screen opens
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(
                      () {
                        final isSelected = controller.selectedMethods.contains(method['value']);
                        
                        return Padding(
                          padding: const EdgeInsets.only(bottom: 16.0),
                          child: GestureDetector(
                            onTap: () => controller.toggleMethod(method['value']),
                            child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              spacing: 8,
                              runSpacing: 8,
                              children: controller.selectedMethods
                                  .map(
                                    (method) => Container(
              ...
              Obx(
                () => CustomButton(
                  title: 'Continue',
                  isEnabled: controller.selectedMethods.isNotEmpty && !controller.isLoading.value,
                  isLoading: controller.isLoading.value,
                  onPressed: () {
                    if (controller.selectedMethods.isEmpty) {
                      Get.snackbar(
                    ...
                    controller.submitPaymentMethods();
                  },
                ),
              ),
              const SizedBox(height: 16),
