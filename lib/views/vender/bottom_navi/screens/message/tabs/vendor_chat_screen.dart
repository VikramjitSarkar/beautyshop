...
class VendorChatScreen extends StatefulWidget {
  ...
  @override
  State<VendorChatScreen> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<VendorChatScreen> {
  final VendorChatController chatController = Get.put(
  ...
  void initState() {
    ...
    chatController.initSocket(widget.chatId); // ← must be called
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isMe = senderId == chatController.currentUserId.value;
